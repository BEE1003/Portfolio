    ...
    <div className="min-h-screen bg-background">
      <header className="fixed inset-x-0 top-0 z-40 border-b border-border bg-background/90 backdrop-blur">
        <nav className="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-8 font-mono text-xs text-foreground/75">
      ...
      <main id="top">
        ...
        <section className="relative flex min-h-[90vh] flex-col items-center justify-center px-6 pt-24 pb-16 text-center">
          <div className="mx-auto max-w-2xl">
            ...
            <p className="mt-5 text-base leading-8 text-foreground/78">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              <Button
                ...
                size="lg"
                variant="outline"
                className="font-mono text-xs tracking-widest hover:border-primary hover:bg-primary hover:text-primary-foreground"
              >
                <a href="#work">檢視作品集</a>
              </Button>
              <Button
            ...
            <dl className="mt-14 grid grid-cols-3 gap-6 border-t border-border pt-8 font-mono text-xs">
              {[
                ["1~2 年", "工作經歷"],
                ["VR / AR / WebGL", "專案類型"],
                ["C# · Unity3D", "主要技術"],
        ...
        <section id="about" className="border-t border-border py-20">
          <div className="mx-auto grid max-w-5xl gap-12 px-6 md:grid-cols-[1fr_1fr]">
            <div>
              ...
              <h2 className="mt-4 text-2xl font-medium tracking-tight">經歷</h2>
              <ol className="mt-8 space-y-8 border-l border-border pl-6">
                <li className="relative">
                  ...
                  <p className="font-mono text-xs text-muted-foreground">2024/8 – 2026/5</p>
                  <h3 className="mt-1 text-base font-medium">Unity 工程師 · 愛吠的狗娛樂股份有限公司</h3>
                ...
                <li className="relative">
                  <span className="absolute -left-[25px] top-1.5 h-1.5 w-1.5 rounded-full bg-foreground" />
                  <p className="font-mono text-xs text-muted-foreground">2022/9 – 2023/6</p>
                  <h3 className="mt-1 text-base font-medium">遊戲程式 · 畢業專題「太空狗狗GO!」</h3>
                  <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                ...
                <li className="relative">
                  <span className="absolute -left-[25px] top-1.5 h-1.5 w-1.5 rounded-full bg-foreground" />
                  <p className="font-mono text-xs text-muted-foreground">2019/9 – 2023/6</p>
                  <h3 className="mt-1 text-base font-medium">南臺科技大學 · 多媒體與電腦娛樂科學系</h3>
                  <p className="mt-2 text-sm leading-relaxed text-muted-foreground">大學畢業</p>
                </li>
              </ol>
            </div>
            ...
            <div>
              ...
              <h2 className="mt-4 text-2xl font-medium tracking-tight">技術與認證</h2>
        ...
        <section id="work" className="border-t border-border py-20">
          <div className="mx-auto max-w-5xl px-6">
            ...
            <h2 className="mt-4 text-2xl font-medium tracking-tight">作品集</h2>
        ...
        <section id="contact" className="border-t border-border py-20">
          <div className="mx-auto grid max-w-5xl gap-12 px-6 md:grid-cols-2">
            <div>
              ...
              <h2 className="mt-4 text-2xl font-medium tracking-tight">聯絡我</h2>
              <p className="mt-4 max-w-md text-sm leading-relaxed text-muted-foreground">
                目前待業中、錄取後隨時可上班，希望職稱為 Unity 工程師（高雄市，對遠端工作有意願）。歡迎來信聊聊職缺或專案合作。
              </p>
              <ul className="mt-8 space-y-3 font-mono text-sm">
                <li>
                  <a
                    href="mailto:bee881003@gmail.com"
                    className="inline-flex items-center gap-3 text-muted-foreground transition-colors hover:text-foreground"
                  >
                    <Mail className="h-4 w-4" /> bee881003@gmail.com
                  </a>
                </li>
                <li className="inline-flex items-center gap-3 text-muted-foreground">
                  <Phone className="h-4 w-4" /> 0968-135-002
                </li>
                <li className="inline-flex items-center gap-3 text-muted-foreground">
                  <MapPin className="h-4 w-4" /> 高雄市大寮區
                </li>
                <li className="inline-flex items-center gap-3 text-muted-foreground">
                  <GraduationCap className="h-4 w-4" /> 南臺科技大學 多媒體與電腦娛樂科學系
                </li>
              </ul>
            </div>

            <form
              className="space-y-4 border border-border bg-card/95 p-6 shadow-[0_0_0_1px_color-mix(in_oklab,var(--primary)_10%,transparent)]"
              onSubmit={(e) => {
                e.preventDefault();
            ...
            >
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="name" required placeholder="你的名字" />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Textarea id="message" required rows={6} placeholder="想聊聊的內容…" />
              </div>
              <Button type="submit" className="w-full font-mono text-xs tracking-widest">
                送出訊息
              </Button>
            </form>
          </div>
      ...
      <footer className="border-t border-border py-8">
        <div className="mx-auto max-w-5xl px-6 font-mono text-xs text-muted-foreground">
